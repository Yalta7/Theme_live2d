var L2Dwidget = (function (t) {
  ...
  window.webpackJsonpL2Dwidget = function (e, o, i) {
    for (var c, u, a = 0, f = []; a < e.length; a++)
      (u = e[a]), r[u] && f.push(r[u][0]), (r[u] = 0);
      ...
      function (t, n, e, l, p) {
        ...
        if (i(b)) {
          for (v = u(t.length); v > w; w++)
            if ((y = n ? m(c((d = t[w]))[0], d[1]) : m(t[w])) === f || y === s)
              return y;
        } else
  ...
  function (t, n, e) {
    ...
    t.exports = function (t, n, e) {
      return (
        ...
        function () {
          for (
            var i = arguments, c = -1, u = o(i.length - n, 0), a = Array(u);
            ++c < u;
  ...
  function (t, n, e) {
    ...
    t.exports = function t(n, e, i, c, u, a) {
      return (
        o(n) && o(e) && (a.set(e, n), r(n, e, void 0, t, a), a.delete(e)), n
      );
    };
  },
  function (t, n, e) {
  ...
  function (t, n, e) {
    ...
    t.exports = function (t) {
      var n = this.__data__,
        e = r(n, t);
      return !(
        e < 0 || (e == n.length - 1 ? n.pop() : o.call(n, e, 1), --this.size, 0)
      );
    };
  },
  function (t, n, e) {
...
webpackJsonpL2Dwidget([0], {
  133: function (t, i, e) {
    ...
    function v(t) {
      ...
      "touchstart" == t.type
        ...
        ? ((i = $),
          ...
          (n = A(i.clientY - e.top)),
          (s = m(
            { x: e.left + e.width / 2, y: e.top + e.height * d },
    ...
    (i.theRealInit = function () {
      ...
      (c = new s.L2DViewMatrix()).setScreenRect(e, _, y, d),
        ...
        (f = new s.L2DMatrix44()).multScale(
          1,
          o.currCanvas.width / o.currCanvas.height
        ),
        (g = new s.L2DMatrix44()).multTranslate(
          -o.currCanvas.width / 2,
          -o.currCanvas.height / 2
        ),
        ...
        u ||
          ...
          (function t() {
            ...
            i(t, o.currCanvas),
              void 0 !== l && (l(o.currCanvas.toDataURL()), (l = void 0));
          })());
    }),
  ...
  134: function (t, i, e) {
    ...
    (function (t) {
      ...
      function f(t, i, e, r) {
        c.prototype.constructor.call(this, i, e, r),
          (this._$tL = null),
          (this._$tL = t);
      }
      function g(t, i, e) {
      ...
      (r._$0s = 1),
        ...
        (r._$62 = function (t, i) {
          try {
            ...
            if (e >= G._$s7) {
              ...
              if (-30584 != $ || -30584 != l)
                throw (
                  ((t._$NP |= r._$0s), new ht("_$gi _$C _$li , _$0 _$6 _$Ui."))
                );
            }
            t._$KS(h);
        ...
        (r.prototype.getModelImpl = function () {
          return (
            null == this._$MT && ((this._$MT = new l()), this._$MT._$zP()),
            this._$MT
          );
        }),
          ...
          if (0 != e)
            if (1 == t.length) {
              ...
              var _ = 0 != s.getParamFloat(p),
                ...
                h = e / r;
              _ ? (a += h) > 1 && (a = 1) : (a -= h) < 0 && (a = 0),
                s.setPartsOpacity(c, a);
            } else {
        ...
        (r.prototype.getPartsDataIndex = function (t) {
          return (
            t instanceof h || (t = h.getID(t)), this._$5S.getPartsDataIndex(t)
          );
        }),
        (r.prototype.getPartsOpacity = function (t) {
          return (
            "number" != typeof t &&
              (t = this._$5S.getPartsDataIndex(h.getID(t))),
        ...
        (o.prototype.init = function (t, i, e) {
          for (var r = 0; r < i.length; r++) {
            ...
            if (null != o) {
              ...
              null == s &&
                ((s = new n(this, t, o)), this.clipContextList.push(s));
          ...
          if (e > 0) {
            ...
            (s[0] = 0),
              ...
              i.gl.viewport(
                0,
                0,
                _t.clippingMaskBufferSize,
                _t.clippingMaskBufferSize
              ),
              this.setupLayoutBounds(e),
              i.gl.bindFramebuffer(
                i.gl.FRAMEBUFFER,
                _t.frameBuffers[this.curFrameNo].framebuffer
              ),
            ...
            for (r = 0; r < this.clipContextList.length; r++) {
              ...
              for (
                var c = o.clippingMaskDrawIndexList.length, f = 0;
                f < c;
                f++
              ) {
      ...
      (T._$ni = function (t, i, e, r, o, n, s, _, a) {
        ...
        (S._$br = function (t, i, e, r) {
          ...
          if (4 == o) {
            ...
            return (
              (1 - B) *
                ((1 - N) *
                  ((1 - T) * (P + (S - P) * l) + T * (v + (L - v) * l)) +
                  N * ((1 - T) * (M + (E - M) * l) + T * (A + (I - A) * l))) +
              B *
                ((1 - N) *
                  ((1 - T) * (x + (w - x) * l) + T * (D + (O - D) * l)) +
        ...
        (S._$Vr = function (t, i, e, r, o, n, s, _) {
          ...
          if (a <= 0) {
            ...
            for (
              var Mt = 1 << a, Et = new Float32Array(Mt), At = 0;
              At < Mt;
              At++
            ) {
            ...
            for (var Dt = new Float32Array(Mt), Ot = 0; Ot < Mt; Ot++)
              Dt[Ot] = o[h[Ot]];
            for (c = 0; c < l; ) {
              var Rt = 0,
                bt = 0,
                Ft = c + 1;
              for (Ot = 0; Ot < Mt; Ot++)
                (Rt += Et[Ot] * Dt[Ot][c]), (bt += Et[Ot] * Dt[Ot][Ft]);
        ...
        (L.prototype._$Nr = function (t, i) {
          if (
            ((i._$IS[0] = !1),
            (i._$Us = S._$Z2(t, this._$GS, i._$IS, this._$Lb)),
            _t._$Zs)
          );
        ...
        (D.prototype._$Ur = function (t) {
          ...
          for (var i = t._$v2(), e = this._$Ob.length - 1; e >= 0; --e) {
            ...
            if (
              (r == x._$ds && (r = t.getParamIndex(this._$Ob[e].getParamID())),
              t._$Xb(r))
            )
              return !0;
          }
          ...
          for (
            ...
            if (a._$RP == N._$hs) {
              ...
              var u = t.getParamFloat($),
                ...
                c =
                  u +
                  (p + (a._$I0[n + 1 >= h ? h - 1 : n + 1] - p) * s - u) * e;
              t.setParamFloat($, c);
            }
          }
          n >= this._$yT &&
        ...
        (U.prototype.init = function () {
          ...
          for (
            ...
            for (var a = _.getBaseData(), h = a.length, $ = 0; $ < h; ++$)
              r.push(a[$]);
            for ($ = 0; $ < h; ++$) {
              var l = a[$].init(this);
              l._$l2(s), n.push(l);
        ...
        (U.prototype.update = function () {
          ...
          for (var t = this._$_2.length, i = 0; i < t; i++)
            this._$_2[i] != this._$vr[i] &&
              ((this._$Js[i] = U._$ZS), (this._$vr[i] = this._$_2[i]));
          ...
          for (i = 0; i < n; i++)
            (this._$Ws[i] = U._$V2), (this._$Vs[i] = U._$V2);
        ...
        (k.prototype._$7T = function (t) {
          ...
          switch (this._$_L) {
            ...
            case STATE_OPENING:
              ...
              break;
            case STATE_INTERVAL:
              this._$12 < e && ((this._$_L = V.STATE_CLOSING), (this._$bb = e)),
                (i = 1);
              break;
            case STATE_FIRST:
            default:
      ...
      (V.STATE_FIRST = "STATE_FIRST"),
        ...
        (z.prototype._$2b = function (t, i) {
          ...
          if ((e._$hS(!0), this._$32())) {
            ...
            if (
              (e._$8r == A._$ur && (e._$8r = t.getBaseDataIndex(r)), e._$8r < 0)
            )
        ...
        (ot.prototype.drawElements = function (t, i, e, r, o, n, s, a) {
          try {
            ...
            for (
              ...
              if (
                (n || (n = 1.2),
                _t.IGNORE_EXPAND && (n = 0),
                _t.USE_CACHED_POLYGON_IMAGE)
              ) {
                var it = a._$e0;
                if (
                  ...
                  (_t.DEBUG_DATA.LDGL_CANVAS_MB =
                    _t.DEBUG_DATA.LDGL_CANVAS_MB || 0),
                ...
                _t.IGNORE_CLIP ||
                  ot.clip(u, y, n, k, O, R, b, F, C, N, E, A, I, x, w, D),
                  _t.USE_ADJUST_TRANSLATION &&
                    ((W = 0), (j = $), (q = 0), (J = l)),
        ...
        (ot.clipWithTransform = function (t, i, e, r, o, n, s, a) {
          if (arguments.length < 7) _._$li("err : @LDGL.clip()");
            ...
            if ((t.beginPath(), $)) {
              ...
              for (var u = 4; u < l.length; u += 2)
                $._$PS(l[u], l[u + 1], h), t.lineTo(h[0], h[1]);
            } else {
              t.moveTo(l[2], l[3]);
          ...
          try {
            ...
            if (!e && (W.prototype._$2b.call(this, t), this._$32())) {
              ...
              if (
                ...
                null == n || s._$x2()
                  ? (r._$AT = !1)
                  : (n._$nb(t, s, r._$Cr, r._$hr, this._$d0, B._$i2, B._$No),
                    (r._$AT = !0)),
        ...
        (dt.prototype.disposeShader = function () {
          var t = this.gl;
          this.shaderProgram &&
            (t.deleteProgram(this.shaderProgram), (this.shaderProgram = null)),
            this.shaderProgramOff &&
        ...
        (dt.prototype.loadShaders2 = function () {
          ...
          if (
            ...
            return (
              ...
              this.shaderProgram &&
                (t.deleteProgram(this.shaderProgram), (this.shaderProgram = 0)),
              this.vertShaderOff &&
                (t.deleteShader(this.vertShaderOff), (this.vertShaderOff = 0)),
              this.fragShaderOff &&
      ...
      (Pt.prototype._$bT = function () {
        ...
        (vt._$kT = [
          ...
          0.172295, 0.184465, 0.196606, 0.208718, 0.220798, 0.232844, 0.244854,
          0.256827, 0.268761, 0.280654, 0.292503, 0.304308, 0.316066, 0.327776,
          0.339436, 0.351044, 0.362598, 0.374097, 0.385538, 0.396921, 0.408243,
          0.419502, 0.430697, 0.441826, 0.452888, 0.463881, 0.474802, 0.485651,
          0.496425, 0.507124, 0.517745, 0.528287, 0.538748, 0.549126, 0.559421,
          0.56963, 0.579752, 0.589785, 0.599728, 0.609579, 0.619337, 0.629,
          0.638567, 0.648036, 0.657406, 0.666676, 0.675843, 0.684908, 0.693867,
          0.70272, 0.711466, 0.720103, 0.72863, 0.737045, 0.745348, 0.753536,
          0.76161, 0.769566, 0.777405, 0.785125, 0.792725, 0.800204, 0.807561,
          0.814793, 0.821901, 0.828884, 0.835739, 0.842467, 0.849066, 0.855535,
          0.861873, 0.868079, 0.874153, 0.880093, 0.885898, 0.891567, 0.897101,
          0.902497, 0.907754, 0.912873, 0.917853, 0.922692, 0.92739, 0.931946,
          0.936359, 0.940629, 0.944755, 0.948737, 0.952574, 0.956265, 0.959809,
          0.963207, 0.966457, 0.96956, 0.972514, 0.97532, 0.977976, 0.980482,
          0.982839, 0.985045, 0.987101, 0.989006, 0.990759, 0.992361, 0.993811,
          0.995109, 0.996254, 0.997248, 0.998088, 0.998776, 0.999312, 0.999694,
          0.999924, 1,
        ]),
        ...
        (Mt.setup = function () {
          ...
          if ((t = i.indexOf("iPhone OS ")) >= 0)
            (r.os = "iPhone"),
              (r._isIPhone = !0),
              (r.version = e(i, t + "iPhone OS ".length));
          else if ((t = i.indexOf("iPad")) >= 0) {
            if ((t = i.indexOf("CPU OS")) < 0)
              return void _._$li(" err : " + i + " @UtHtml5.setup()");
            (r.os = "iPad"),
              (r._isIPad = !0),
              (r.version = e(i, t + "CPU OS ".length));
          } else
            (t = i.indexOf("Android")) >= 0
              ? ((r.os = "Android"),
                (r._isAndroid = !0),
                (r.version = e(i, t + "Android ".length)))
              : ((r.os = "-"), (r.version = -1));
        }),
        _t.init();
      e = !1;
    ...
    (o.prototype.getModelMatrix = function () {
      ...
      (o.prototype.loadExpression = function (t, i, e) {
        ...
        r.loadBytes(i, function (i) {
          null != t && (o.expressions[t] = s.loadJson(i)),
            "function" == typeof e && e();
        });
      }),
      ...
      (s.loadJson = function (t) {
        ...
        for (var n = 0; n < o; n++) {
          ...
          if (
            ...
            var p;
            0 == (p = null == a.def ? 1 : parseFloat(a.def)) && (p = 1),
              ($ /= p);
          }
          var c = new _();
    ...
    (h.STATE_FIRST = "STATE_FIRST"),
      ...
      (c.load = function (t) {
        for (
          ...
          for (
            var n = e[o].group, s = n.length, _ = new Array(), a = 0;
            a < s;
            a++
          ) {
            var h = n[a],
      ...
      (y.prototype.adjustScale = function (t, i, e) {
        ...
        $.mul(n, this.tr, this.tr),
          $.mul(o, this.tr, this.tr),
          $.mul(r, this.tr, this.tr);
      }),
  ...
  137: function (t, i, e) {
    ...
    (i.createElement = function () {
      ...
      r.setAttribute("id", o.config.name.canvas),
        r.setAttribute(
          "width",
          o.config.display.width * o.config.display.superSample
        ),
        r.setAttribute(
          "height",
          o.config.display.height * o.config.display.superSample
        ),
        ...
        r.style.setProperty(
          o.config.display.position,
          o.config.display.hOffset + "px"
        ),
    ...
    (a.prototype = new r.L2DBaseModel()),
              ...
              n.loadTexture(i, o, function () {
                if (n.isTexLoaded) {
                  if (n.modelSetting.getExpressionNum() > 0) {
                    ...
                    for (
                      var t = 0;
                      t < n.modelSetting.getExpressionNum();
                      t++
                    ) {
                      var i = n.modelSetting.getExpressionName(t),
                        o =
                          n.modelHomeDir + n.modelSetting.getExpressionFile(t);
                  ...
                  if (
                    ...
                    null != n.modelSetting.getPhysicsFile()
                      ? n.loadPhysics(
                          n.modelHomeDir + n.modelSetting.getPhysicsFile()
                        )
                      : (n.physics = null),
                    null != n.modelSetting.getPoseFile()
                      ? n.loadPose(
                          n.modelHomeDir + n.modelSetting.getPoseFile(),
                          function () {
      ...
      (a.prototype.update = function () {
        if (null != this.live2DModel) {
          var t =
            2 *
            ((_.UtSystem.getUserTimeMSec() - this.startTimeMSec) / 1e3) *
            Math.PI;
          this.mainMotionManager.isFinished() &&
            this.startRandomMotion(
              s.cDefine.MOTION_GROUP_IDLE,
              s.cDefine.PRIORITY_IDLE
            ),
